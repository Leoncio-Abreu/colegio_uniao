...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.4 -->
    <link href="{{ asset("/bower_components/admin-lte/bootstrap/css/bootstrap.min.back.css") }}" rel="stylesheet" type="text/css" />
...
.sizer {
  height: 120px;
    ...
    @include('partials._head')
      ...
      <script src="{{ asset ("/jquery-ui/base/jquery-ui.min.js") }}"></script>
      <!-- Bootstrap 3.3.2 JS -->
